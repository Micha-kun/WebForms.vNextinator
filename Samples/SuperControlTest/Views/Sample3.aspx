...
<body>
    ...
    <div>
       ...
       Set a new title (leave blank for default): <asp:TextBox ID="txbNewTitle" runat="server" Text="<%# ViewModel.Title %>" OnPreRender="ControlDataBind"/><br />
         Set a new label to show (leave blank for default): <asp:TextBox ID="txbNewLabelToShow" runat="server" Text="<%# ViewModel.LabelToShow %>" OnPreRender="ControlDataBind"/><br />
