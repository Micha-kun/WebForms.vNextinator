...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            Set a new title (leave blank for validation error or type "#" to see cascade dependecy betwen values):
            <asp:TextBox EnableViewState="false" ID="txbNewTitle" runat="server" Text="<%# ViewModel.Title %>" OnPreRender="ControlDataBind" /><br />
            Set a new label to show (leave blank for default):
            <asp:TextBox EnableViewState="false" ID="txbNewLabelToShow" runat="server" Text="<%# ViewModel.LabelToShow %>" OnPreRender="ControlDataBind" /><br />
